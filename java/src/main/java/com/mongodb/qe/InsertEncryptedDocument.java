...
public class InsertEncryptedDocument {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Document docRegular = regularClient.getDatabase(encryptedDbName).getCollection(encryptedCollName).find(eq("firstName", fname)).first();
        ...
        Document docSecure = mongoClientSecure.getDatabase(encryptedDbName).getCollection(encryptedCollName).find(eq("patientRecord.ssn", pssn)).first();
